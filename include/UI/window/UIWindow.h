...
public:
	...
	bool IsNowClickOn() const { return isNowClickOn; }
	...
	void SetNowClickOn(bool active) { isNowClickOn = active; }
	void SetClosed(bool closed) { isClosed = closed; }

	int GetZOrder() const { return m_zOrder; }
	void SetZOrder(int zOrder) { m_zOrder = zOrder; }
	std::vector<float> GetSize() { return std::vector{ x,y,width,height }; }
