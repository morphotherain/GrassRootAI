...
void WindowManager::Update(float dt, DirectX::Mouse& mouse, DirectX::Keyboard& keyboard, UINT tick) {
	...
	if (m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::NumPad1)
		|| m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::D1)) {
		DEBUG_("打开market窗口");
		WindowMessage msg;
	...
	if (m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::NumPad2)
		|| m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::D2)) {
		DEBUG_("打开cargo窗口");
		WindowMessage msg;
	...
	if (m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::NumPad3)
		|| m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::D3)) {
	...
	if (m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::NumPad4)
		|| m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::D4)) {
		DEBUG_("打开industry窗口");
		WindowMessage msg;
	...
	if (m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::NumPad5)
		|| m_KeyboardTracker.IsKeyPressed(Keyboard::Keys::D5)) {
		DEBUG_("打开skill窗口");
		WindowMessage msg;
...
void WindowManager::Reset()
{
	...
	m_maxWindowZOrder = 0;
	WindowMessagingSystem::GetInstance().Clear();
}
