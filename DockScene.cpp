...
std::vector<DockScene::MapVertexPosColor>  DockScene::GenerateVertices(int n) {
...
void DockScene::UpdateScene(float dt, DirectX::Mouse& mouse, DirectX::Keyboard& keyboard, int& switchScene)
{
	// 更新鼠标事件，获取相对偏移量
