...
void StargateLoadingScene::OnResize()
{
}

void StargateLoadingScene::UpdateScene(float dt, DirectX::Mouse& mouse, DirectX::Keyboard& keyboard, UINT tick)
{
	// 更新鼠标事件，获取相对偏移量
...
void StargateLoadingScene::DrawScene()
{
...
void StargateLoadingScene::cleanup()
{
}

bool StargateLoadingScene::InitResource()
{
	tick = 0;
	...
	std::vector<std::string> textureFileNames = {
		"demoTex\\StargateLoadingScene\\background.dds"
	};
...
bool StargateLoadingScene::InitEffect()
{
	return true;
}